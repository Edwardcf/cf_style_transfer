...
style_path  = '/content/sample_data/96ba62b9ef11a447dc95a03231b28806.jpg'


content_path= '/content/sample_data/download (2).png'
...
x = tf.keras.applications.vgg19.preprocess_input(content_image*215)
...
y = tf.keras.applications.vgg19.preprocess_input(style_image*215)
y = tf.image.resize(y, (224, 224))
vgg = tf.keras.applications.VGG19(include_top=True, weights='imagenet')
prediction_probabilities = vgg(y)
prediction_probabilities.shape
imshow(y)
